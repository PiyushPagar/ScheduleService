...
public class StaahCSVBookingDto {
	...
	public String toString() {
		return "StaahCSVBookingDto [propertyId=" + propertyId + ", timeBooked=" + timeBooked + ", timeModified="
				+ timeModified + ", bookingNo=" + bookingNo + ", channel=" + channel + ", channelRef=" + channelRef
				+ ", status=" + status + ", checkinDate=" + checkinDate + ", checkoutDate=" + checkoutDate
				+ ", noOfRooms=" + noOfRooms + ", roomId=" + roomId + ", roomType=" + roomType + ", rateId=" + rateId
				+ ", ratePlan=" + ratePlan + ", currency=" + currency + ", rateValue=" + rateValue + ", commision="
				+ commision + ", taxValue=" + taxValue + ", totalAmount=" + totalAmount + ", netAmount=" + netAmount
				+ ", noOfExtraAdult=" + noOfExtraAdult + ", extraAdultRate=" + extraAdultRate + ", noOfChild="
				+ noOfChild + ", extraChildRate=" + extraChildRate + ", addon=" + addon + ", addonRate=" + addonRate
				+ "]";
	}
